...
class MultiplicativeBuilderInterface(BuilderInterface):
    def __init__(self, start_date: datetime, end_date: datetime, freq: str):
        self.start_date = start_date
        self.end_date = end_date
        self.freq = freq
        self._end_product = TimeSeriesGenerator(self.start_date, self.end_date, self.freq, DataTypeEnum.MULTIPLICATIVE)
