...
from time_series_components_generator.interactive_components.seasonality.monthly_seasonality import MonthlySeasonality
...
class TestQuarterlySeasonality(unittest.TestCase):
    def test_quarterly_seasonality_creation_success(self):
        ...
        self.assertIsInstance(MonthlySeasonality(time_interval), Seasonality)
    ...
    def test_quarterly_seasonality_generate_data_component_success(self):
        ...
        answer_generate_data = MonthlySeasonality(time_interval).generate_data_component()
